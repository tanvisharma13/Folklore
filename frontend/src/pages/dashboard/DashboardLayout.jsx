...
import profilePic from '../../assets/team.jpg'
...
const DashboardLayout = () => {
  ...
  return (
    ...
    <aside className="hidden sm:flex sm:flex-col">
      <a href="/" className="inline-flex items-center justify-center w-20 h-20 bg-purple-600 hover:bg-purple-500 focus:bg-purple-500">
        <img src="/fav-icon.png" alt="" />
      </a>
      <div className="flex flex-col justify-between flex-grow text-gray-500 bg-gray-800">
        <nav className="flex flex-col mx-4 my-6 space-y-4">
          <a href="#" className="inline-flex items-center justify-center py-3 rounded-lg hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700">
          ...
          <Link to="/dashboard/add-new-book" className="inline-flex items-center justify-center py-3 rounded-lg hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700">
            <span className="sr-only">Add Book</span>
            <HiViewGridAdd className="w-6 h-6"/>
          </Link>
          <Link to="/dashboard/manage-books" className="inline-flex items-center justify-center py-3 rounded-lg hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700">
    ...
    <div className="flex-grow text-gray-800">
      <header className="flex items-center h-20 px-6 bg-white sm:px-10">
        <button className="relative flex-shrink-0 block p-2 mr-2 text-gray-600 rounded-full sm:hidden hover:bg-gray-100 hover:text-gray-800 focus:bg-gray-100 focus:text-gray-800">
        ...
        <div className="relative w-full max-w-md sm:-ml-2">
          ...
          <input type="text" role="search" placeholder="Search..." className="w-full py-2 pl-10 pr-4 placeholder-gray-400 border-4 border-transparent rounded-lg focus:bg-gray-50" />
        </div>
        <div className="flex items-center flex-shrink-0 ml-auto">
          <button className="inline-flex items-center p-2 rounded-lg hover:bg-gray-100 focus:bg-gray-100">
            ...
            <span className="w-12 h-12 ml-2 mr-2 overflow-hidden bg-gray-100 rounded-full sm:ml-3">
              <img src={profilePic} alt="user profile" className="object-cover w-full h-full"/>
            </span>
            <svg aria-hidden="true" viewBox="0 0 20 20" fill="currentColor" className="hidden w-6 h-6 text-gray-300 sm:block">
      ...
      <main className="p-6 space-y-6 sm:p-10 ">
        <div className="flex flex-col justify-between space-y-6 md:space-y-0 md:flex-row">
          ...
          <div className="flex flex-col items-start justify-end -mb-3 md:flex-row">
            <Link to="/dashboard/manage-books" className="inline-flex px-5 py-3 mb-3 text-purple-600 border border-purple-600 rounded-md hover:text-purple-700 focus:text-purple-700 hover:bg-purple-100 focus:bg-purple-100">
              <svg aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="flex-shrink-0 h-5 w-5 -ml-1 mt-0.5 mr-2">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
              </svg>
              Manage Books
            </Link>
            <Link to="/dashboard/add-new-book" className="inline-flex px-5 py-3 mb-3 ml-6 text-white bg-purple-600 rounded-md hover:bg-purple-700 focus:bg-purple-700">
